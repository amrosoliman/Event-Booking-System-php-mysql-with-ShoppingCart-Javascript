...
window.onload = function() {
    ...
    window.id = document.getElementById('event_id').innerHTML;
    window.price = document.getElementById('event_price').innerHTML;
     window.name = document.getElementById('event_name').innerHTML;
     var contents =  {"id": window.id, "price": window.price, "name": window.name};
     ...
     const CART = {
        ...
        init(){
            ...
            if(_contents){
                CART.window.contents = JSON.parse(_contents);
            }else{
                //dummy test data
                localStorage.setItem('user', window.id);
